    ...
    export const kanaRows: Kana[][] = [
        ...
        [ { hiragana: 'や', katakana: 'ヤ', romaji: 'ya' }, { hiragana: '', katakana: '', romaji: '' }, { hiragana: 'ゆ', katakana: 'ユ', romaji: 'yu' }, { hiragana: '', katakana: '', romaji: '' }, { hiragana: 'よ', katakana: 'ヨ', romaji: 'yo' } ],
        ...
        [ { hiragana: 'わ', katakana: 'ワ', romaji: 'wa' }, { hiragana: '', katakana: '', romaji: '' }, { hiragana: '', katakana: '', romaji: '' }, { hiragana: '', katakana: '', romaji: '' }, { hiragana: 'を', katakana: 'ヲ', romaji: 'wo' } ],
        [ { hiragana: 'ん', katakana: 'ン', romaji: 'n' } ]
    ];

    // 濁音+半濁音
    export const voicedKanaRows: Kana[][] = [
