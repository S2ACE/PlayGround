...
const KanaDialog = ({
	...
	return (
		...
		>
			...
			>
				<IconButton onClick={handleClear} aria-label="清除筆畫">
					<Box
						component="img"
						src={ResetIcon}
						alt="clear"
			...
			{/* Left & right arrows for navigating between kana */}
			{/* Left arrow */}
			{!isFirst && (
				<IconButton
					onClick={onPrev}
			...
			>
				...
				{/* Right: KanaSpeak with stable position */}
				<Box
					sx={{
						ml: 1,
						flexShrink: 0,
